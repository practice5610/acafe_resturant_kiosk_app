...
class PosScaffold extends StatelessWidget {
  ...
  /// Home / browse / orders / receipts / settings are edge-to-edge under the
  /// nav — Figma frames for those tabs include their own rails and panel
  /// padding. Other tabs keep the original padded placeholder frame.
  ...
  Widget build(BuildContext context) {
    ...
    final Widget body = _isEdgeToEdge(currentPath)
        ? child
        : Padding(
